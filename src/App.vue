<template>
  <div id="app" style="margin: 0">
    <title>Suffyan Academy</title>
    <nav class="navbar navbar-expand-lg navbar-light background-nav text-white">
      <div class="container px-4 px-lg-5">
        <h3 class="navbar-logo ms-0 me-4" style="width: 15%">Suffyan Academy</h3>
        <button
